...
export const ES_ENGLISH_PROSE_WORKS: Record<string, string> = {
  ...
  // SOLO EN LATÍN, y el español de esos capítulos se hizo del LATÍN, el testigo primario. Lo mismo
  // pasa en Hermas 107:5 y 109–114 (23 secciones más): 34 secciones en total. El TEI de origen
  // escribía ese latín con letras griegas («ιν ηις εργο στατε» = «in his ergo state»);
  // scripts/fix-af-latin.py lo devolvió al alfabeto latino y le puso `lang: 'la'`, así que ahora
  // se muestra como latín y no se le ofrece al lector un análisis morfológico inventado.
  'af-polycarp': 'apostolic-fathers/polycarp',
  // LA DIDACHÉ. Es de nivel CAPÍTULO (una fila = un capítulo, AF_CHAPTER_LEVEL en prose-texts.ts):
  // el griego lleva los números de sección intercalados en el texto y el inglés de Lightfoot NO.
  ...
  'lys-in-defense-of-mantitheus': 'greco/lys-in-defense-of-mantitheus',
  'lys-on-the-property-of-eraton': 'greco/lys-on-the-property-of-eraton',
  'lys-olympic-oration': 'greco/lys-olympic-oration',
  'lys-against-the-subversion-of-the-ancestral-cons': 'greco/lys-against-the-subversion-of-the-ancestral-cons',
  'lys-against-epicrates-and-his-fellow-envoys': 'greco/lys-against-epicrates-and-his-fellow-envoys',
  'lys-against-ergocles': 'greco/lys-against-ergocles',
  'lys-against-philocrates': 'greco/lys-against-philocrates',
  'lys-on-the-refusal-of-a-pension': 'greco/lys-on-the-refusal-of-a-pension',
  'lys-against-the-corn-dealers': 'greco/lys-against-the-corn-dealers',
  'lys-on-the-scrutiny-of-evandros': 'greco/lys-on-the-scrutiny-of-evandros',
  'lys-defense-against-a-charge-of-taking-bribes': 'greco/lys-defense-against-a-charge-of-taking-bribes',
  'lys-against-alcibiades-2': 'greco/lys-against-alcibiades-2',
  'lys-against-pancleon': 'greco/lys-against-pancleon',
  'lys-on-the-confiscation-of-the-property-of-the-b': 'greco/lys-on-the-confiscation-of-the-property-of-the-b',
  'lys-against-diogeiton': 'greco/lys-against-diogeiton',
  'lys-against-nicomachus': 'greco/lys-against-nicomachus',
  'lys-against-philon': 'greco/lys-against-philon',
  'lys-for-polystratus': 'greco/lys-for-polystratus',
  'lys-defense-against-a-charge-of-subverting-the-d': 'greco/lys-defense-against-a-charge-of-subverting-the-d',
  'lys-against-alcibiades-1': 'greco/lys-against-alcibiades-1',
  'lys-on-the-property-of-aristophanes': 'greco/lys-on-the-property-of-aristophanes',
  'lys-against-agoratus': 'greco/lys-against-agoratus',
  'lys-funeral-oration': 'greco/lys-funeral-oration',
  ...
  'herodotus-histories-3': 'greco/herodotus-histories-3',
  'herodotus-histories-4': 'greco/herodotus-histories-4',
  ...
  'herodotus-histories-9': 'greco/herodotus-histories-9',
