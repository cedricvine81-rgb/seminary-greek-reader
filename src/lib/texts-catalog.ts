...
import { TWELVE_PATRIARCHS_CATALOG, PHILO_CATALOG, AF_CATALOG, TG_CATALOG, ANF_CATALOG, JUSTIN_CATALOG, EUSEBIUS_CATALOG, EUSEBIUS_PE_CATALOG, CLEMENT_CATALOG, ORIGEN_CATALOG, ATHANASIUS_CATALOG, MISHNAH_CATALOG, YERUSHALMI_CATALOG, BAVLI_CATALOG, TOSEFTA_CATALOG, GRECO_CATALOG, PLATO_CATALOG, ARISTOTLE_CATALOG, PLUTARCH_CATALOG, APOLLODORUS_CATALOG, LUCIAN_CATALOG, XENOPHON_CATALOG, QUINTILIAN_CATALOG, THUCYDIDES_CATALOG, POLYBIUS_CATALOG, STRABO_CATALOG, PAUSANIAS_CATALOG, HOMER_CATALOG, HESIOD_CATALOG, HERODOTUS_CATALOG, DIO_CHAPTER_NUMBERS, type EmbeddedProseSource } from '@/lib/prose-texts'
...
const RAW_CATEGORIES: TextCategory[] = [
  ...
  },
  {
    ...
    works: [...JUSTIN_CATALOG, ...ANF_CATALOG, ...EUSEBIUS_CATALOG, ...EUSEBIUS_PE_CATALOG, ...CLEMENT_CATALOG, ...ORIGEN_CATALOG, ...ATHANASIUS_CATALOG],
  },
  {
    id: 'nt-apocrypha',
    label: 'NT Apocrypha',
  ...
  },
  {
    ...
    works: [
      ...
      ...([
        ...
        ...POLYBIUS_CATALOG, ...STRABO_CATALOG, ...PAUSANIAS_CATALOG,
