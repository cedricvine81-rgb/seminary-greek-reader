...
const RAW_CATEGORIES: TextCategory[] = [
  ...
  },
  {
    ...
    works: [...JUSTIN_CATALOG, ...ANF_CATALOG, ...EUSEBIUS_CATALOG, ...EUSEBIUS_PE_CATALOG, ...CLEMENT_CATALOG, ...ORIGEN_CATALOG, ...ORIGEN_GREEK_ONLY_CATALOG, ...ATHANASIUS_CATALOG],
  },
  {
    id: 'nt-apocrypha',
    label: 'NT Apocrypha',
