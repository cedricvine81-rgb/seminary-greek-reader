...
export const DEPONENTS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      <Cat id="deponents.cat.direct-middle" name="Direct (reflexive) middle" eg="“he hanged himself”" ex={[{ g: "ἀπελθὼν ἀπήγξατο", e: "he went away and hanged himself", r: "Matt 27:5" }]} how={<T id="deponents.cat.direct-middle.h">Subject and object are the same person, and “himself” would work as a direct object. It is rare, so check whether the indirect middle fits before settling here.</T>}><T id="deponents.cat.direct-middle.d">the subject acts on itself — rare in the New Testament, and the flagged examples are mostly bodily actions</T></Cat>
      <Cat id="deponents.cat.indirect-middle" name="Indirect middle" eg="“choosing for himself”" ex={[{ g: "ἐκλεξάμενος ἀπ’ αὐτῶν δώδεκα", e: "choosing for himself twelve of them", r: "Luke 6:13" }, { g: "περιεποιήσατο διὰ τοῦ αἵματος τοῦ ἰδίου", e: "he obtained for himself through his own blood", r: "Acts 20:28" }]} how={<T id="deponents.cat.indirect-middle.h">Add “for himself” and see whether the sense sharpens. This is the default middle, so try it before any other.</T>}><T id="deponents.cat.indirect-middle.d">the subject acts <em>for itself</em>, in its own interest — much the commonest use</T></Cat>
      <Cat id="deponents.cat.permissive-middle" name="Permissive middle" eg="“get yourself baptised”" ex={[{ g: "ἀναστὰς βάπτισαι καὶ ἀπόλυσαι τὰς ἁμαρτίας σου", e: "rise, get baptised and wash away your sins", r: "Acts 22:16" }]} how={<T id="deponents.cat.permissive-middle.h">The subject is not performing the action but letting it happen to itself. English “get” usually carries it — “get baptised”, not “baptise oneself”.</T>}><T id="deponents.cat.permissive-middle.d">the subject <em>allows</em> the action to be done to itself — the sense often carried in English by “get”</T></Cat>
      <Cat id="deponents.cat.reciprocal-middle" name="Reciprocal middle" eg="“they took counsel together”" ex={[{ g: "συμβούλιον ἔλαβον κατ’ αὐτοῦ", e: "they took counsel together against him", r: "Matt 12:14" }]} how={<T id="deponents.cat.reciprocal-middle.h">The subject must be plural and the action mutual. “One another” is reciprocal; “each to himself” is the direct middle.</T>}><T id="deponents.cat.reciprocal-middle.d">a plural subject acting on one another</T></Cat>
    </CatGroup>
