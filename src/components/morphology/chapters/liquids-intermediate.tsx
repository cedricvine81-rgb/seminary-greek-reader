...
export const LIQUIDS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      <Cat id="liquids.cat.future-contract" name="The future that looks present" eg="μενῶ “I will remain”" ex={[{ g: "ὁ μένων ἐν ἐμοὶ κἀγὼ ἐν αὐτῷ οὗτος φέρει καρπὸν πολύν", e: "the one who remains in me and I in him, he bears much fruit", r: "John 15:5" }]} how={<T id="liquids.cat.future-contract.h">Check whether the stem ends in <G>λ μ ν ρ</G>. If it does, a form that looks like an <G>-έω</G> present may be the future, and the circumflex is the only mark of it.</T>}><T id="liquids.cat.future-contract.d">instead of <G>σ</G> the future inserts an <G>ε</G> which immediately contracts, so a liquid future is spelled like an <G>-έω</G> present. Only the accent separates them</T></Cat>
      <Cat id="liquids.cat.aorist-no-sigma" name="The aorist without σ" eg="μένω → ἔμεινα" ex={[{ g: "ἔμεινεν δὲ Μαριὰμ σὺν αὐτῇ ὡς μῆνας τρεῖς", e: "and Mary remained with her about three months", r: "Luke 1:56" }]} how={<T id="liquids.cat.aorist-no-sigma.h">An augment and <G>α</G>-endings but no <G>σ</G>. Look for the compensation in the stem — a lengthened vowel, or a double consonant simplified.</T>}><T id="liquids.cat.aorist-no-sigma.d">the augment and the α-endings are all there, but the <G>σα</G> is not; the stem usually compensates by lengthening its vowel or simplifying a double consonant</T></Cat>
      <Cat id="liquids.cat.frequency" name="They are not marginal" eg="μένω, ἀποστέλλω, ἐγείρω, κρίνω" ex={[{ g: "καθὼς ἀπέστειλέν με ὁ ζῶν Πατήρ", e: "as the living Father sent me", r: "John 6:57" }, { g: "ὁ Θεὸς αὐτὸν ἤγειρεν ἐκ νεκρῶν", e: "God raised him from the dead", r: "Rom 10:9" }]} how={<T id="liquids.cat.frequency.h">Worth learning as a class rather than as exceptions: <G>μένω</G>, <G>ἀποστέλλω</G>, <G>ἐγείρω</G> and <G>κρίνω</G> alone will meet you on nearly every page.</T>}><T id="liquids.cat.frequency.d">the liquid class holds some of the highest-frequency verbs in the New Testament, so the pattern is met constantly rather than as a curiosity</T></Cat>
    </CatGroup>
