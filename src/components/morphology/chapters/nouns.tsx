...
export const NOUNS_CONTENT = (
  <>
    ...
    <LevelOnly level="beginning">
      ...
      <TableAside
        beginning={<>
          <p><Tr id="nouns.as.one-word-three">One word, three forms, three jobs. You already switch between these without thinking —
          you would never say <em>"Him saw I."</em></Tr></p>
          <p><Tr id="nouns.as.greek-does-exactly">Greek does exactly this, but to <strong>every</strong> noun, using endings. That is the whole
          idea of this chapter.</Tr></p>
        </>}
      >
        <MorphTable id="nouns.t1" tCols={[0, 1, 2, 3]} flush title="The case system English kept" headers={['', 'Subject', 'Possessor', 'Object']} firstColIsData
          rows={[
            ['Pronoun', 'he', 'his', 'him'],
      ...
      <P id="nouns.p.finally-nouns-come">
    ...
    <TableAside
      beginning={<>
        ...
        <p><Tr id="nouns.as.apostle-nom-speaks">"<strong>The apostle</strong> [nom.] speaks <strong>the word</strong> [acc.] <strong>of God</strong> [gen.] <strong>to the crowd</strong> [dat.]."</Tr></p>
        <p><Tr id="nouns.as.one-english-sentence">One English sentence holds all four jobs. Keep it in your head and the cases stop being abstract.</Tr></p>
      </>}
      intermediate={<>
    ...
    <DropdownPractice id="nouns.d1"
      title="Practice — spot the case"
      intro={<Tr id="nouns.intro.which-greek-case">Which Greek case would the <strong>bold</strong> phrase be in? (English first — no endings needed yet.)</Tr>}
      options={["Nominative", "Genitive", "Dative", "Accusative"]}
      items={[
        { q: <Tr id="nouns.q.the-apostle-teaches"><strong>The apostle</strong> teaches the crowd.</Tr>, answer: "Nominative", note: <Tr id="nouns.n.the-doer-the">The doer of the action — the subject.</Tr> },
        { q: <Tr id="nouns.q.god-loves-the">God loves <strong>the world</strong>.</Tr>, answer: "Accusative", note: <Tr id="nouns.n.acted-upon-the">Acted upon — the direct object.</Tr> },
        { q: <Tr id="nouns.q.the-word-the">The word <strong>of the Lord</strong> endures.</Tr>, answer: "Genitive", note: <Tr id="nouns.n.possession-source">"of …" — possession/source.</Tr> },
        { q: <Tr id="nouns.q.she-speaks-the">She speaks <strong>to the disciples</strong>.</Tr>, answer: "Dative", note: <Tr id="nouns.n.for-the-ones">"to/for …" — the ones spoken to.</Tr> },
        { q: <Tr id="nouns.q.heard-the-voice">We heard the voice <strong>of an angel</strong>.</Tr>, answer: "Genitive" },
        { q: <Tr id="nouns.q.the-children-hear"><strong>The children</strong> hear the word.</Tr>, answer: "Nominative" },
        { q: <Tr id="nouns.q.gives-the-bread">He gives the bread <strong>to the crowd</strong>.</Tr>, answer: "Dative" },
      ]}
    />
    ...
    <TableAside
      beginning={<>
        ...
        <Ex grc="ὁ λόγος" en={<Tr id="nouns.ex.word-subject">the word (subject)</Tr>} />
        <Ex grc="τοῦ λόγου" en={<Tr id="nouns.ex.word">of the word</Tr>} />
        <Ex grc="τῷ λόγῳ" en={<Tr id="nouns.ex.word-2">to / for the word</Tr>} />
        <Ex grc="τὸν λόγον" en={<Tr id="nouns.ex.word-direct-object">the word (direct object)</Tr>} />
        <p><Tr id="nouns.as.two-shortcuts-neuter">Two shortcuts: the neuter copies the masculine except in the nom./acc., and the neuter's
        nominative and accusative are always identical.</Tr></p>
      </>}
      intermediate={<>
        <p><Tr id="nouns.as.one-paradigm-covers">One paradigm covers nouns <em>and</em> adjectives. Endings repeat across genders
        (<Gk>‒ων</Gk> is the genitive plural everywhere), so let the article settle an ambiguous form.</Tr></p>
        <AsideLabel><Tr id="nouns.al.sentence">In a sentence</Tr></AsideLabel>
    ...
    <DropdownPractice id="nouns.d2"
      title="Practice — parse the form"
      intro={<Tr id="nouns.intro.pick-case-number">Pick the case and number. Read each form as stem + ending before you choose.</Tr>}
      ...
      items={[
        ...
        { q: <span className="normal-case">ἔργα</span>, answer: "Nom/Acc Plural (neuter)", note: <Tr id="nouns.n.neuter-nominative-and">Neuter nominative and accusative are always identical — the sentence must decide.</Tr> },
    ...
    <TableAside
      beginning={<>
        <AsideLabel><Tr id="nouns.al.article-gives-parse">The article gives you the parse</Tr></AsideLabel>
        <Ex grc="ὁ λόγος" en={<Tr id="nouns.ex.word-says-masc">the word (ὁ says: masc. nominative)</Tr>} />
        <Ex grc="ἡ ἀρχή" en={<Tr id="nouns.ex.beginning-fem">the beginning (fem.)</Tr>} />
        <Ex grc="τὸ ἔργον" en={<Tr id="nouns.ex.work-neut">the work (neut.)</Tr>} />
        <p><Tr id="nouns.as.memorize-article's-forms">Memorize the article's forms early — it is the highest-value memory work in all of Greek.</Tr></p>
      </>}
    >
    ...
    <DropdownPractice id="nouns.d3"
      title="Practice — parse the article"
      intro={<Tr id="nouns.intro.article-answer-key">The article is your answer key — so learn to parse it on sight. Pick the case and number.</Tr>}
      ...
      items={[
        { q: <span className="normal-case">τοῦ</span>, answer: "Genitive Singular", note: <Tr id="nouns.n.masculine-neuter-serves">Masculine or neuter — τοῦ serves both.</Tr> },
        { q: <span className="normal-case">ταῖς</span>, answer: "Dative Plural", note: <Tr id="nouns.n.feminine">Feminine.</Tr> },
        { q: <span className="normal-case">τόν</span>, answer: "Accusative Singular", note: <Tr id="nouns.n.masculine">Masculine.</Tr> },
        { q: <span className="normal-case">ἡ</span>, answer: "Nominative Singular", note: <Tr id="nouns.n.feminine-2">Feminine.</Tr> },
        { q: <span className="normal-case">τῶν</span>, answer: "Genitive Plural", note: <Tr id="nouns.n.all-three-genders">All three genders — context decides.</Tr> },
        { q: <span className="normal-case">τῷ</span>, answer: "Dative Singular", note: <Tr id="nouns.n.masculine-neuter">Masculine or neuter.</Tr> },
        { q: <span className="normal-case">αἱ</span>, answer: "Nominative Plural", note: <Tr id="nouns.n.feminine-3">Feminine.</Tr> },
      ]}
    />

    <ClassSentences id="nouns.cs2"
    ...
    <TableAside
      beginning={<>
        <AsideLabel><Tr id="nouns.al.default-translations-2">Default translations</Tr></AsideLabel>
        <Ex grc="ἡ σάρξ" en={<Tr id="nouns.ex.flesh-subject">the flesh (subject)</Tr>} />
        <Ex grc="τῆς σαρκός" en={<Tr id="nouns.ex.flesh">of the flesh</Tr>} />
        <Ex grc="τῇ σαρκί" en={<Tr id="nouns.ex.flesh-2">to / for the flesh</Tr>} />
        <Ex grc="τὴν σάρκα" en={<Tr id="nouns.ex.flesh-object">the flesh (object)</Tr>} />
        <p><Tr id="nouns.as.vocabulary-tip-always">Vocabulary tip: always learn a 3rd-declension noun <em>with its genitive</em> — that is where
        the stem lives.</Tr></p>
      </>}
      intermediate={<>
        <p><Tr id="nouns.as.nominative-disguises-stem">The nominative disguises the stem because stem consonants collide with <Gk>‒ς</Gk>
        (<Gk>σαρκ + ς → σάρξ</Gk>; dentals drop: <Gk>ἐλπιδ + ς → ἐλπίς</Gk>).</Tr></p>
        <p><Tr id="nouns.as.dative-plural-triggers">The dative plural <Gk>‒σι(ν)</Gk> triggers the same consonant + <Gk>σ</Gk> changes as the future
    ...
    <DropdownPractice id="nouns.d4"
      title="Practice — parse the 3rd-declension form"
      intro={<Tr id="nouns.intro.find-hidden-stem">Find the hidden stem first (drop ‑ος from the genitive), then pick the case and number.</Tr>}
      options={["Nominative Singular", "Genitive Singular", "Dative Singular", "Accusative Singular", "Nominative Plural", "Genitive Plural", "Dative Plural", "Accusative Plural", "Nom/Acc Plural (neuter)"]}
      items={[
        ...
        { q: <span className="normal-case">πίστεως</span>, answer: "Genitive Singular", note: <Tr id="nouns.n.the-vowel-stem">πίστις, πίστεως — the vowel-stem family with the ‑εως genitive.</Tr> },
    ...
    {/* ── 4 · How to translate ───────────────────────────── */}
    <LevelOnly level="beginning">
    <SectionHeading id="nouns.h.how-translate-three">How to translate: the three-step method</SectionHeading>
    <P id="nouns.p.never-translate-greek">
    ...
    <InfoBox>
      <ol className="list-decimal list-inside space-y-1 text-sm text-gray-700">
        <li><Tr id="nouns.wo.find-case-every"><strong>Find the case of every noun</strong> — read the articles and endings.</Tr></li>
        <li><Tr id="nouns.wo.ask-why-each"><strong>Ask why each word has that case</strong> — who is the subject? the object? what is the "of" phrase attached to?</Tr></li>
        <li><Tr id="nouns.wo.then-build-english"><strong>Then build the English sentence</strong> — in English order, with "of / to / for" supplied.</Tr></li>
      </ol>
    </InfoBox>
    <P id="nouns.p.watch-work-scrambled">Watch it work on a scrambled sentence:</P>
    <TableAside
      beginning={<>
      ...
      intermediate={<>
        <p><Tr id="nouns.as.word-order-greek">Word order in Greek is rhetorical, not grammatical: fronting marks emphasis or contrast. When you
    ...
    <P id="nouns.p.adjective-describes-noun">
    ...
    <P id="nouns.p.position-matters-inside">
    ...
    <TableAside
      beginning={<>
        ...
        <p><Tr id="nouns.as.all-every-whole"><Gk>πᾶς, πᾶσα, πᾶν</Gk> = "all, every, whole" — the most common adjective in the NT, and a preview
        of things to come: its masculine/neuter run on the 3rd declension while its feminine runs on the 1st.</Tr></p>
        <Ex grc="πᾶς ἄνθρωπος" en={<Tr id="nouns.ex.every-person">every person</Tr>} />
        <Ex grc="πάντες" en={<Tr id="nouns.ex.everyone">everyone</Tr>} />
      </>}
      intermediate={<>
        <p><Tr id="nouns.as.same-declension-split">The same 3rd + 1st declension split reappears in every active participle
        (<Gk>λύων, λύουσα, λῦον</Gk>) — master <Gk>πᾶς</Gk> now and participles will feel familiar later.</Tr></p>
        <p><Tr id="nouns.as.sense-shifts-article">Sense shifts with the article: <Gk>πᾶσα πόλις</Gk> "every city," <Gk>πᾶσα ἡ πόλις</Gk> "the whole city."</Tr></p>
      </>}
    >
      <MorphTable id="nouns.t7" tCols={[0, 1]} flush title="πᾶς, πᾶσα, πᾶν  (all, every)" headers={['','','Masc. (3rd)','Fem. (1st)','Neut. (3rd)']}
        rows={[
    ...
    <DropdownPractice id="nouns.d5"
      title="Practice — which position?"
      intro={<Tr id="nouns.intro.attributive-describes-inside">Attributive describes inside the article–noun unit; predicate makes a statement; substantival stands alone as a noun.</Tr>}
      ...
      items={[
        ...
        { q: <span className="normal-case">ὁ λόγος ἀγαθός</span>, answer: "Predicate — \"the word is good\"", note: <Tr id="nouns.n.outside-the-articlenoun">Outside the article–noun unit — it asserts, with no "is" written.</Tr> },
        { q: <span className="normal-case">οἱ ἅγιοι</span>, answer: "Substantival — \"the good (ones)\"", note: <Tr id="nouns.n.article-adjective-noun">Article + adjective, no noun: "the holy ones," "the saints."</Tr> },
        { q: <span className="normal-case">ὁ λόγος ὁ καλός</span>, answer: "Attributive — \"the good word\"", note: <Tr id="nouns.n.the-second-attributive">The second attributive position — the repeated article keeps it inside the unit.</Tr> },
        { q: <span className="normal-case">ἁγία ἡ ἐκκλησία</span>, answer: "Predicate — \"the word is good\"" },
        { q: <span className="normal-case">τὰ ἀγαθά</span>, answer: "Substantival — \"the good (ones)\"", note: <Tr id="nouns.n.the-good-things">"The good things."</Tr> },
      ]}
    />

    <ClassSentences id="nouns.cs4"
    ...
    <InfoBox>
      <ul className="list-disc list-inside space-y-1.5 text-sm text-gray-700">
        ...
        <li><Tr id="nouns.wo.double-booked-declension"><Gk>‒ος</Gk> is double-booked: 2nd-declension nominative singular (<Gk>λόγος</Gk>) <em>and</em> 3rd-declension genitive singular (<Gk>σαρκός</Gk>). The article settles it: <Gk>ὁ</Gk> vs. <Gk>τῆς</Gk>.</Tr></li>
        <li><Tr id="nouns.wo.neuter-nominative-accusative">Neuter nominative and accusative are always identical (<Gk>τὸ ἔργον, τὰ ἔργα</Gk>) — decide subject vs. object from the rest of the sentence.</Tr></li>
        <li><Tr id="nouns.wo.breathing-marks-distinguish">Breathing marks distinguish real words: <Gk>ἐν</Gk> "in" vs. <Gk>ἕν</Gk> "one"; <Gk>εἰς</Gk> "into" vs. <Gk>εἷς</Gk> "one."</Tr></li>
      </ul>
    </InfoBox>
    ...
    <GuidedExample
      ...
      steps={[
        { prompt: <Tr id="nouns.gp.step-find-the">Step 1 — find the cases. What does <span className="normal-case">τόν</span> tell you about <span className="normal-case">λόγον</span>?</Tr>,
          answer: <Tr id="nouns.ga.accusative-singular-masculine">Accusative singular masculine — so <span className="normal-case">τὸν λόγον</span> is the <strong>direct object</strong>, even though it comes first.</Tr> },
        { prompt: <Tr id="nouns.gp.what-and-what">What is <span className="normal-case">τοῦ θεοῦ</span>, and what does it attach to?</Tr>,
          answer: <Tr id="nouns.ga.genitive-god-hangs">Genitive — "of God." It hangs on the noun before it: "the word <em>of God</em>."</Tr> },
        { prompt: <Tr id="nouns.gp.who-doing-the">Who is doing the hearing?</Tr>,
          answer: <Tr id="nouns.ga.nominative-the-article"><span className="normal-case">ὁ μαθητής</span> — nominative (the article ὁ says so), therefore the <strong>subject</strong>. A 1st-declension <em>masculine</em> noun: the article outranks the ‑ης ending.</Tr> },
        { prompt: <Tr id="nouns.gp.step-assemble-english">Step 3 — assemble it in English order.</Tr>,
          answer: <Tr id="nouns.ga.subject-verb-object">Subject → verb → object → "of" phrase: <em>the disciple / hears / the word / of God</em>.</Tr> },
      ]}
    ...
    <GuidedExample
      ...
      translation={<Tr id="nouns.gt.you-are-the">"You are the Son of God" — Nathanael's confession, built entirely from this chapter's grammar.</Tr>}
    />
    ...
    <Practice id="nouns.pr1"
      ...
      items={[
        { q: <span className="normal-case">τοῦ κυρίου</span>,
          a: <Tr id="nouns.pa.genitive-singular-masculine">Genitive singular masculine — "of the Lord." The article <span className="normal-case">τοῦ</span> gives it away.</Tr>},
        { q: <span className="normal-case">τοῖς ἀνθρώποις</span>,
          a: <Tr id="nouns.pa.dative-plural-masculine">Dative plural masculine — "to / for the people."</Tr>},
        { q: <span className="normal-case">τὴν ἡμέραν</span>,
          a: <Tr id="nouns.pa.accusative-singular-feminine">Accusative singular feminine — "the day" as a direct object.</Tr>},
        { q: <span className="normal-case">τὸ εὐαγγέλιον</span>,
          a: <Tr id="nouns.pa.neuter-singular-nominative">Neuter singular — nominative <em>or</em> accusative ("the gospel"): the neuter's nom. and acc. are identical, so the sentence must decide.</Tr>},
        { q: <span className="normal-case">τοῦ πατρός</span>,
          a: <Tr id="nouns.pa.genitive-singular-masculine-2">Genitive singular masculine (3rd declension) — "of the father." Note the <span className="normal-case">‑ος</span> ending here is <em>genitive</em>, not nominative: trust the article.</Tr>},
      ]}
    />
    <Practice id="nouns.pr2"
      title="Practice B — translate the sentence"
      intro={<Tr id="nouns.intro.use-three-step">Use the three-step method: cases first, then jobs, then English.
        Vocabulary: <span className="normal-case">γινώσκει</span> "knows" · <span className="normal-case">λέγει</span> "says/speaks" · <span className="normal-case">ἀκούουσιν</span> "they hear" · <span className="normal-case">λαμβάνει</span> "receives" · <span className="normal-case">μαθητής</span> "disciple."</Tr>}
      items={[
        { q: <span className="normal-case">ὁ θεὸς γινώσκει τὸν ἄνθρωπον.</span>,
          a: <Tr id="nouns.pa.god-knows-man">"God knows the man." <span className="normal-case">ὁ θεός</span> nominative = subject; <span className="normal-case">τὸν ἄνθρωπον</span> accusative = object.</Tr>},
        { q: <span className="normal-case">τὸν λόγον τοῦ κυρίου ἀκούουσιν οἱ μαθηταί.</span>,
          a: <Tr id="nouns.pa.disciples-hear-word">"The disciples hear the word of the Lord." The object came first — the cases, not the order, tell you <span className="normal-case">οἱ μαθηταί</span> (nominative) is the subject.</Tr>},
        { q: <span className="normal-case">λέγει ὁ ἀπόστολος τοῖς ἀδελφοῖς.</span>,
          a: <Tr id="nouns.pa.apostle-speaks-brothers">"The apostle speaks to the brothers." <span className="normal-case">τοῖς ἀδελφοῖς</span> dative = the ones spoken <em>to</em>.</Tr>},
        { q: <span className="normal-case">τὸ εὐαγγέλιον λαμβάνει ὁ μαθητής.</span>,
          a: <Tr id="nouns.pa.disciple-receives-gospel">"The disciple receives the gospel." Trap: <span className="normal-case">τὸ εὐαγγέλιον</span> could be nom. or acc. (neuter!), but <span className="normal-case">ὁ μαθητής</span> is unambiguously nominative — so it must be the subject.</Tr>},
        { q: <span className="normal-case">κύριός ἐστιν ὁ υἱὸς τοῦ ἀνθρώπου. (Mark 2:28)</span>,
          a: <Tr id="nouns.pa.son-man-lord">"The Son of Man is Lord." Both nouns are nominative (equative <span className="normal-case">ἐστίν</span>) — the articular <span className="normal-case">ὁ υἱός</span> is the subject, anarthrous <span className="normal-case">κύριος</span> the predicate. Real verse, this chapter's grammar.</Tr>},
      ]}
    />
    ...
    <LiveExamples
      ...
      links={[
        ...
        { label: <Tr id="nouns.le.dative-plural">Dative plural nouns — spot the ‑οις / ‑αις / ‑σι endings</Tr>, features: ['noun', 'dative', 'plural'] },
