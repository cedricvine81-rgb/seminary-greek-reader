...
export const SUBJUNCTIVES_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
            <Cat id="subjunctives.cat.hortatory"name="Hortatory" eg="“let us love one another”" ex={[{ g: "ἀγαπῶμεν ἀλλήλους", e: "let us love one another", r: "1 John 4:7" }, { g: "διέλθωμεν ἕως Βηθλέεμ", e: "let us go over to Bethlehem", r: "Luke 2:15" }]} how={<T id="subjunctives.cat.hortatory.h">First person plural, no introductory word, and the speaker includes himself in what he urges. “Let us” is the translation.</T>}><T id="subjunctives.cat.hortatory.d">1st person plural — an exhortation</T></Cat>
            <Cat id="subjunctives.cat.deliberative"name="Deliberative" eg="“what shall we say?”" ex={[{ g: "τί οὖν ποιήσωμεν;", e: "what then shall we do?", r: "Luke 3:10" }, { g: "δῶμεν ἢ μὴ δῶμεν;", e: "shall we pay, or shall we not?", r: "Mark 12:14" }]} how={<T id="subjunctives.cat.deliberative.h">It is a question and the mood is subjunctive. The speaker is asking what should be done, not what will be.</T>}><T id="subjunctives.cat.deliberative.d">a real or rhetorical question about what to do</T></Cat>
            <Cat id="subjunctives.cat.emphatic-negation"name="Emphatic Negation" eg="“will never perish”" ex={[{ g: "οὐ μὴ ἀπόλωνται εἰς τὸν αἰῶνα", e: "they shall never perish", r: "John 10:28" }, { g: "οἱ λόγοι μου οὐ μὴ παρέλθωσιν", e: "my words will never pass away", r: "Matt 24:35" }]} how={<T id="subjunctives.cat.emphatic-negation.h">The double negative <G>οὐ μή</G> with an aorist subjunctive — the strongest denial Greek can make. It states, it does not forbid.</T>}><T id="subjunctives.cat.emphatic-negation.d"><G>οὐ μή</G> + aorist subjunctive — the strongest “no”</T></Cat>
            <Cat id="subjunctives.cat.prohibitive"name="Prohibitive" eg="“do not fear”" ex={[{ g: "μὴ φοβηθῇς παραλαβεῖν Μαριάμ", e: "do not be afraid to take Mary", r: "Matt 1:20" }, { g: "μὴ δόξητε λέγειν ἐν ἑαυτοῖς", e: "do not presume to say among yourselves", r: "Matt 3:9" }]} how={<T id="subjunctives.cat.prohibitive.h"><G>μή</G> with an aorist subjunctive, standing in for the second-person aorist imperative Greek does not have. Read it as a command.</T>}><T id="subjunctives.cat.prohibitive.d"><G>μή</G> + aorist subjunctive (a negative command)</T></Cat>
    </CatGroup>
    <SectionHeading id="subjunctives.cg.in-dependent-clauses">In dependent clauses</SectionHeading>
    <CatGroup>
            <Cat id="subjunctives.cat.subjunctive"name="ἵνα + subjunctive" ex={[{ g: "ἵνα πᾶς ὁ πιστεύων εἰς αὐτὸν ἔχῃ ζωὴν αἰώνιον", e: "that whoever believes in him may have eternal life", r: "John 3:16" }, { g: "ἦλθεν ἵνα μαρτυρήσῃ περὶ τοῦ φωτός", e: "he came to bear witness about the light", r: "John 1:7" }]} how={<T id="subjunctives.cat.subjunctive.h"><G>ἵνα</G> introduces it. Purpose is intended and result merely follows — though in John <G>ἵνα</G> has drifted far enough that it can mean little more than “that”.</T>}><T id="subjunctives.cat.subjunctive.d">purpose (“in order that”) or result (“so that”)</T></Cat>
