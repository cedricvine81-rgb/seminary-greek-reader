...
export const INFINITIVES_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
            <Cat id="infinitives.cat.purpose"name="Purpose" eg="“I came to destroy the law”" ex={[{ g: "οὐκ ἦλθον καταλῦσαι ἀλλὰ πληρῶσαι", e: "I did not come to abolish but to fulfill", r: "Matt 5:17" }, { g: "ἐξῆλθεν ὁ σπείρων σπεῖραι", e: "the sower went out to sow", r: "Mark 4:3" }]} how={<T id="infinitives.cat.purpose.h">Ask “why?” looking forward and try “in order to”. <G>τοῦ</G>, <G>εἰς τό</G> and <G>πρὸς τό</G> point this way, but a bare infinitive after a verb of motion is just as often purpose.</T>}><T id="infinitives.cat.purpose.d">answers <em>why?</em> — “in order to”; naked inf., or <G>τοῦ / εἰς τό / πρὸς τό</G></T></Cat>
            <Cat id="infinitives.cat.result"name="Result" eg="“…so that the crowd was amazed”" ex={[{ g: "ὥστε τὸν ὄχλον θαυμάσαι", e: "so that the crowd marveled", r: "Matt 15:31" }, { g: "ὥστε ἤδη γεμίζεσθαι τὸ πλοῖον", e: "so that the boat was already filling", r: "Mark 4:37" }]} how={<T id="infinitives.cat.result.h"><G>ὥστε</G> is the usual marker. The test against purpose is whether the outcome was intended: purpose is aimed at, result merely follows.</T>}><T id="infinitives.cat.result.d">the outcome produced; usually <G>ὥστε</G> + infinitive</T></Cat>
            <Cat id="infinitives.cat.time"name="Time" ex={[{ g: "ἐν τῷ σπείρειν αὐτόν", e: "while he was sowing", r: "Matt 13:4" }, { g: "μετὰ τὸ ἐγερθῆναί με", e: "after I have been raised", r: "Matt 26:32" }]} how={<T id="infinitives.cat.time.h">A preposition with the article fixes the relation — <G>μετὰ τό</G> after, <G>ἐν τῷ</G> while, <G>πρὸ τοῦ</G> before. Read the preposition, not the infinitive.</T>}><T id="infinitives.cat.time.d">answers <em>when?</em> — <G>μετὰ τό</G> "after," <G>ἐν τῷ</G> "while," <G>πρὸ τοῦ</G> "before"</T></Cat>
            <Cat id="infinitives.cat.causal"name="Causal" eg="“because it had no root”" ex={[{ g: "διὰ τὸ μὴ ἔχειν ῥίζαν", e: "because it had no root", r: "Mark 4:6" }, { g: "διὰ τὸ εἶναι αὐτὸν ἐξ οἴκου καὶ πατριᾶς Δαυείδ", e: "because he was of the house of David", r: "Luke 2:4" }]} how={<T id="infinitives.cat.causal.h"><G>διὰ τό</G>, and the sense looks back to a reason already in place. Purpose looks forward; cause looks back.</T>}><T id="infinitives.cat.causal.d">answers <em>why?</em> looking back; <G>διὰ τό</G> + infinitive</T></Cat>
            <Cat id="infinitives.cat.complementary"name="Complementary" eg="“you cannot serve God and mammon”" ex={[{ g: "οὐ δύνασθε θεῷ δουλεύειν καὶ μαμωνᾷ", e: "you cannot serve God and mammon", r: "Matt 6:24" }, { g: "ἤρξατο ὁ Ἰησοῦς κηρύσσειν", e: "Jesus began to preach", r: "Matt 4:17" }]} how={<T id="infinitives.cat.complementary.h">The main verb cannot stand alone — <G>δύναμαι</G>, <G>θέλω</G>, <G>μέλλω</G>, <G>ἄρχομαι</G> all need completing. If removing the infinitive leaves the sentence unfinished, it is complementary.</T>}><T id="infinitives.cat.complementary.d">completes a helper verb (<G>δύναμαι, θέλω, μέλλω, ἄρχομαι</G>)</T></Cat>
    </CatGroup>
    <SectionHeading id="infinitives.cg.substantival-use-like">Substantival use (like a noun)</SectionHeading>
    <CatGroup>
            <Cat id="infinitives.cat.subject"name="Subject" eg="“to live is Christ” (Phil 1:21)" ex={[{ g: "ἐμοὶ τὸ ζῆν Χριστὸς καὶ τὸ ἀποθανεῖν κέρδος", e: "to live is Christ and to die is gain", r: "Phil 1:21" }, { g: "καλόν ἐστιν ἡμᾶς ὧδε εἶναι", e: "it is good for us to be here", r: "Mark 9:5" }]} how={<T id="infinitives.cat.subject.h">Try “to do X is …”. The impersonal verbs — <G>δεῖ</G>, <G>ἔξεστιν</G> — take a subject infinitive almost by definition.</T>}><T id="infinitives.cat.subject.d">the infinitive is the subject, often with <G>δεῖ, ἔξεστιν</G></T></Cat>
            <Cat id="infinitives.cat.indirect-discourse"name="Indirect Discourse" eg="“they say there is no resurrection”" ex={[{ g: "λέγουσιν ἀνάστασιν μὴ εἶναι", e: "they say there is no resurrection", r: "Mark 12:18" }, { g: "τίνα με λέγουσιν εἶναι;", e: "who do they say that I am?", r: "Mark 8:27" }]} how={<T id="infinitives.cat.indirect-discourse.h">A verb of saying, thinking or perceiving comes first, and the infinitive carries what was said or thought. Its own subject, where expressed, is accusative.</T>}><T id="infinitives.cat.indirect-discourse.d">reports speech/thought after a verb of perception</T></Cat>
            <Cat id="infinitives.cat.epexegetical"name="Epexegetical" eg="“authority to tread on serpents”" ex={[{ g: "ἐξουσίαν τοῦ πατεῖν ἐπάνω ὄφεων", e: "authority to tread on serpents", r: "Luke 10:19" }, { g: "ἐξουσίαν ἔχω θεῖναι αὐτήν", e: "I have authority to lay it down", r: "John 10:18" }]} how={<T id="infinitives.cat.epexegetical.h">It explains the noun or adjective right beside it — authority, freedom, need, worthy. Ask “authority to do what?” and the infinitive answers.</T>}><T id="infinitives.cat.epexegetical.d">explains a noun or adjective (ability, freedom, need…)</T></Cat>
    </CatGroup>
    <SectionHeading id="infinitives.h.going-deeper-infinitive">Further study: the infinitive in theological argument</SectionHeading>
