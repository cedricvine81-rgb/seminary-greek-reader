...
export const CONTRACT_VERBS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      <Cat id="contract-verbs.cat.circumflex-witness" name="The circumflex as witness" eg="ποιῶν (contract) vs a hypothetical ποίων" ex={[{ g: "ὁ ποιῶν τὴν ἀλήθειαν ἔρχεται πρὸς τὸ φῶς", e: "the one who does the truth comes to the light", r: "John 3:21" }]} how={<T id="contract-verbs.cat.circumflex-witness.h">Ask where the accent would have fallen had no contraction happened, then compare. A circumflex on the last syllable of a present is the fusion showing through.</T>}><T id="contract-verbs.cat.circumflex-witness.d">where a contract verb’s accent sits tells you a contraction happened; the uncontracted accent usually survives the fusion, which is why it can land where a non-contract verb would never put it</T></Cat>
      <Cat id="contract-verbs.cat.liquid-future" name="Against the liquid future" eg="μενῶ / μένω" ex={[{ g: "μείνατε ἐν ἐμοί κἀγὼ ἐν ὑμῖν", e: "remain in me, and I in you", r: "John 15:4" }]} how={<T id="contract-verbs.cat.liquid-future.h">Check the lexicon for a liquid stem — <G>λ μ ν ρ</G>. If the verb is liquid, something that looks like an <G>-έω</G> present may be a future, and only the accent will say.</T>}><T id="contract-verbs.cat.liquid-future.d">a liquid future contracts too, so it wears an <G>-έω</G> present’s clothes. <G>μενῶ</G> “I will remain” differs from present <G>μένω</G> by accent alone</T></Cat>
      <Cat id="contract-verbs.cat.lexical-form" name="The lexical form is uncontracted" eg="ποιέω → ποιεῖ" ex={[{ g: "ὁ Πατήρ μου ἕως ἄρτι ἐργάζεται κἀγὼ ἐργάζομαι", e: "my Father is working until now, and I am working", r: "John 5:17" }]} how={<T id="contract-verbs.cat.lexical-form.h">Undo the contraction before you search. A <G>-ῶ</G> can come from <G>-άω</G>, <G>-έω</G> or <G>-όω</G>, so try all three stems rather than the form on the page.</T>}><T id="contract-verbs.cat.lexical-form.d">dictionaries list <G>ποιέω</G>, the page shows <G>ποιεῖ</G>. Searching for what you see will fail; the stem vowel has to be restored before you can look anything up</T></Cat>
      <Cat id="contract-verbs.cat.outside-present" name="Only two tenses contract" eg="ποιῶ but ἐποίησα" ex={[{ g: "ἃ γὰρ ἂν ἐκεῖνος ποιῇ ταῦτα καὶ ὁ υἱὸς ποιεῖ ὁμοίως", e: "for whatever that one does, these things the Son also does likewise", r: "John 5:19" }]} how={<T id="contract-verbs.cat.outside-present.h">If the form carries a tense marker — a <G>σ</G>, a <G>θη</G>, reduplication — the question does not arise. Only the present and the imperfect ever contract.</T>}><T id="contract-verbs.cat.outside-present.d">contraction needs a connecting vowel to meet the stem vowel, which happens in the present and imperfect only. Everywhere else the stem vowel simply lengthens and the verb is ordinary</T></Cat>
    </CatGroup>
