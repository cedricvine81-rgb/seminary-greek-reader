...
export const IMPERATIVES_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
            <Cat id="imperatives.cat.command"name="Command" eg="“Go and make disciples”" ex={[{ g: "πορευθέντες μαθητεύσατε πάντα τὰ ἔθνη", e: "go and make disciples of all nations", r: "Matt 28:19" }, { g: "ἀκολούθει μοι", e: "follow me", r: "Matt 9:9" }]} how={<T id="imperatives.cat.command.h">The speaker has the standing to require it and nothing softens it. Then read the aspect: aorist for the act as a whole, present for conduct to be kept up.</T>}><T id="imperatives.cat.command.d">a straightforward order, usually superior to inferior</T></Cat>
            <Cat id="imperatives.cat.prohibition"name="Prohibition" eg="“do not fear”" ex={[{ g: "μὴ φοβοῦ, μόνον πίστευε", e: "do not fear, only believe", r: "Mark 5:36" }, { g: "μὴ κρίνετε, ἵνα μὴ κριθῆτε", e: "do not judge, so that you may not be judged", r: "Matt 7:1" }]} how={<T id="imperatives.cat.prohibition.h"><G>μή</G>, never <G>οὐ</G> — the negative itself tells you the mood is not indicative. Then read the aspect: present to stop something already running, aorist to rule it out.</T>}><T id="imperatives.cat.prohibition.d"><G>μή</G> + imperative forbids an action</T></Cat>
            <Cat id="imperatives.cat.request-entreaty"name="Request / Entreaty" eg="“give us this day our daily bread”" ex={[{ g: "τὸν ἄρτον ἡμῶν δὸς ἡμῖν σήμερον", e: "give us this day our daily bread", r: "Matt 6:11" }, { g: "κύριε, βοήθει μοι", e: "Lord, help me", r: "Matt 15:25" }]} how={<T id="imperatives.cat.request-entreaty.h">The direction is upwards — an inferior addressing a superior, and very often prayer. The form is an ordinary imperative; only the relationship makes it a request.</T>}><T id="imperatives.cat.request-entreaty.d">a polite appeal, often inferior to superior</T></Cat>
            <Cat id="imperatives.cat.permissive"name="Permissive" ex={[{ g: "ὃ ποιεῖς ποίησον τάχιον", e: "what you do, do quickly", r: "John 13:27" }, { g: "εἰ ὁ ἄπιστος χωρίζεται, χωριζέσθω", e: "if the unbeliever separates, let it be so", r: "1 Cor 7:15" }]} how={<T id="imperatives.cat.permissive.h">The speaker is conceding the action rather than requiring it, and it is nearly always third person — which is why English has to reach for “let”.</T>}><T id="imperatives.cat.permissive.d">allows or tolerates an action ("let him do it")</T></Cat>
            <Cat id="imperatives.cat.conditional"name="Conditional" ex={[{ g: "λύσατε τὸν ναὸν τοῦτον, καὶ ἐγερῶ αὐτόν", e: "destroy this temple, and I will raise it up", r: "John 2:19" }, { g: "ἐγγίσατε τῷ θεῷ, καὶ ἐγγιεῖ ὑμῖν", e: "draw near to God, and he will draw near to you", r: "Jas 4:8" }]} how={<T id="imperatives.cat.conditional.h">Two commands in a row, or an imperative followed by a future, where the first is really the condition of the second: “do this, and this will follow”.</T>}><T id="imperatives.cat.conditional.d">an imperative that states a condition ("do X, and Y will follow")</T></Cat>
    </CatGroup>
    ...
    <CatGroup>
      <Cat id="imperatives.cat.proh-present-imv" name="μή + present imperative" eg="μὴ κρίνετε “do not judge”" ex={[{ g: "Μὴ κρίνετε ἵνα μὴ κριθῆτε", e: "do not judge, so that you may not be judged", r: "Matt 7:1" }, { g: "μὴ μεριμνᾶτε τῇ ψυχῇ ὑμῶν τί φάγητε", e: "do not be anxious for your life, what you will eat", r: "Matt 6:25" }]} how={<T id="imperatives.cat.proh-present-imv.h"><G>μή</G> with a present imperative. Ask whether the hearers are already doing it: if they are, “stop”; if not, “do not make a habit of”.</T>}><T id="imperatives.cat.proh-present-imv.d">the <em>process</em> aspect, in Duff’s terms — the prohibition viewed as it runs. Often rendered “do not make a habit of…”, and where the hearers are already doing the thing, “stop”</T></Cat>
      <Cat id="imperatives.cat.proh-aorist-subj" name="μή + aorist subjunctive" eg="μὴ νομίσητε “do not suppose”" ex={[{ g: "Μὴ νομίσητε ὅτι ἦλθον καταλῦσαι τὸν νόμον", e: "do not suppose that I came to abolish the law", r: "Matt 5:17" }, { g: "μὴ οὖν μεριμνήσητε λέγοντες τί φάγωμεν", e: "so do not be anxious, saying, what shall we eat?", r: "Matt 6:31" }]} how={<T id="imperatives.cat.proh-aorist-subj.h"><G>μή</G> with an aorist subjunctive rather than an imperative — because in the second person the aorist imperative is not available. Read it as a plain command, not a softer one.</T>}><T id="imperatives.cat.proh-aorist-subj.d">the prohibitive subjunctive — the form that stands in for the missing aorist imperative. The <em>default</em> aspect: the act forbidden as a whole, and as much a command as any imperative</T></Cat>
      <Cat id="imperatives.cat.proh-third-person" name="μή + third-person aorist imperative" eg="μὴ καταβάτω “let him not go down”" ex={[{ g: "ὁ ἐπὶ τοῦ δώματος μὴ καταβάτω ἆραι τὰ ἐκ τῆς οἰκίας αὐτοῦ", e: "let the one on the housetop not go down to take what is in his house", r: "Matt 24:17" }]} how={<T id="imperatives.cat.proh-third-person.h">Third person and an aorist imperative together — the one place the aorist imperative survives in a prohibition, because no subjunctive idiom competes for the slot.</T>}><T id="imperatives.cat.proh-third-person.d">in the third person the aorist imperative survives in prohibitions, because there is no subjunctive idiom competing for the slot. English has to reach for “let him not…”</T></Cat>
      <Cat id="imperatives.cat.proh-compound" name="μηδέ and μηδείς" eg="μηδενὶ εἴπῃς “tell no one”" ex={[{ g: "ὅρα μηδενὶ εἴπῃς", e: "see that you tell no one", r: "Matt 8:4" }, { g: "μὴ καταβάτω μηδὲ εἰσελθάτω ἆραί τι ἐκ τῆς οἰκίας αὐτοῦ", e: "let him not go down nor go in to take anything out of his house", r: "Mark 13:15" }]} how={<T id="imperatives.cat.proh-compound.h"><G>μηδέ</G> or <G>μηδείς</G> continuing a prohibition <G>μή</G> has already opened. It is the same construction carrying on, not a new one starting.</T>}><T id="imperatives.cat.proh-compound.d">a prohibition already under <G>μή</G> is continued with the compound negatives, which keep the same mood rather than starting a new construction</T></Cat>
      <Cat id="imperatives.cat.proh-ou-me" name="οὐ μή + aorist subjunctive" eg="οὐ μὴ εἰσέλθητε “you will certainly not enter”" ex={[{ g: "οὐ μὴ εἰσέλθητε εἰς τὴν βασιλείαν τῶν οὐρανῶν", e: "you will certainly not enter the kingdom of heaven", r: "Matt 5:20" }]} how={<T id="imperatives.cat.proh-ou-me.h">Both negatives together, <G>οὐ μή</G>, with an aorist subjunctive. It states what will not happen rather than forbidding it — so “will certainly not”, never “do not”.</T>}><T id="imperatives.cat.proh-ou-me.d">not a prohibition but an emphatic denial — the speaker rules the thing out entirely. Read it as “will certainly not,” never as “do not”</T></Cat>
      <Cat id="imperatives.cat.proh-future" name="οὐ + future indicative" eg="οὐ φονεύσεις “you shall not murder”" ex={[{ g: "ἐρρέθη τοῖς ἀρχαίοις οὐ φονεύσεις", e: "it was said to the ancients, you shall not murder", r: "Matt 5:21" }, { g: "τὸ γὰρ οὐ μοιχεύσεις οὐ φονεύσεις οὐ κλέψεις", e: "for the “you shall not commit adultery, you shall not murder, you shall not steal”", r: "Rom 13:9" }]} how={<T id="imperatives.cat.proh-future.h"><G>οὐ</G> with a future indicative where the sense is plainly law rather than prediction. It is the Septuagint's way of rendering the Hebrew commandments, and it keeps that flavour.</T>}><T id="imperatives.cat.proh-future.d">the imperatival future, carried into Greek from the Hebrew of the commandments. It is a flat statement of what will not be done, functioning as an absolute prohibition</T></Cat>
    </CatGroup>
    <P id="imperatives.p.int-aspect-caution">
      ...
      claims, that would be incoherent. Duff’s pair is the safer way to hold it: the present is the
      <em>process</em> aspect and the aorist the <em>default</em>, and neither carries “stop”
