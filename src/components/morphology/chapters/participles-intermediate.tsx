...
export const PARTICIPLES_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
            <Cat id="participles.cat.temporal"name="Temporal" eg="“while eating…”" ex={[{ g: "ἐλθὼν ὁ Ἰησοῦς εἰς τὴν οἰκίαν Πέτρου", e: "when Jesus came into Peter’s house", r: "Matt 8:14" }, { g: "ἀκούσαντες δὲ ἐβαπτίσθησαν", e: "and when they heard, they were baptized", r: "Acts 19:5" }]} how={<T id="participles.cat.temporal.h">No article, and the question it answers is “when?”. An aorist participle usually precedes the main verb in time; a present one runs alongside it.</T>}><T id="participles.cat.temporal.d">answers <em>when?</em></T></Cat>
            <Cat id="participles.cat.cause"name="Cause" eg="“because he was righteous”" ex={[{ g: "Ἰωσὴφ δίκαιος ὢν", e: "Joseph, because he was righteous", r: "Matt 1:19" }, { g: "πλανᾶσθε μὴ εἰδότες τὰς γραφάς", e: "you are wrong because you do not know the Scriptures", r: "Matt 22:29" }]} how={<T id="participles.cat.cause.h">Try “because” in front of it. If the participle gives the reason the main verb happened, that is the category.</T>}><T id="participles.cat.cause.d">answers <em>why?</em> — “because”</T></Cat>
            <Cat id="participles.cat.means-manner"name="Means / Manner" eg="“by doing this…”" ex={[{ g: "τίς μεριμνῶν δύναται προσθεῖναι πῆχυν;", e: "who by worrying can add a single cubit?", r: "Matt 6:27" }, { g: "ἐπορεύοντο χαίροντες", e: "they went on their way rejoicing", r: "Acts 5:41" }]} how={<T id="participles.cat.means-manner.h">It answers “how?”. Means says by what the action was carried out; manner says in what way — try “by —ing”.</T>}><T id="participles.cat.means-manner.d">answers <em>how?</em></T></Cat>
            <Cat id="participles.cat.condition"name="Condition" eg="“if you do this…”" ex={[{ g: "θερίσομεν μὴ ἐκλυόμενοι", e: "we will reap, if we do not give up", r: "Gal 6:9" }, { g: "πῶς ἡμεῖς ἐκφευξόμεθα τηλικαύτης ἀμελήσαντες σωτηρίας;", e: "how shall we escape if we neglect so great a salvation?", r: "Heb 2:3" }]} how={<T id="participles.cat.condition.h">Try “if” in front. The main verb depends on it, and the clause it governs often has a future or an imperative.</T>}><T id="participles.cat.condition.d">the “if” on which the verb depends</T></Cat>
            <Cat id="participles.cat.concession"name="Concession" eg="“although they knew God…”" ex={[{ g: "γνόντες τὸν θεὸν οὐχ ὡς θεὸν ἐδόξασαν", e: "although they knew God, they did not glorify him as God", r: "Rom 1:21" }, { g: "ὃν οὐκ ἰδόντες ἀγαπᾶτε", e: "though you have not seen him, you love him", r: "1 Pet 1:8" }]} how={<T id="participles.cat.concession.h">Try “although”. What marks it is that the main verb happens in spite of what the participle says, not because of it.</T>}><T id="participles.cat.concession.d">“although”</T></Cat>
            <Cat id="participles.cat.purpose"name="Purpose" ex={[{ g: "ἐληλύθει προσκυνήσων εἰς Ἰερουσαλήμ", e: "he had come to worship in Jerusalem", r: "Acts 8:27" }, { g: "ἴδωμεν εἰ ἔρχεται Ἡλείας σώσων αὐτόν", e: "let us see whether Elijah comes to save him", r: "Matt 27:49" }]} how={<T id="participles.cat.purpose.h">A forward-looking “why?”, usually a future participle, or a present one after a verb of motion. Purpose is intended; result is not.</T>}><T id="participles.cat.purpose.d">answers <em>why?</em> looking forward — “in order to”</T></Cat>
    </CatGroup>
    <SectionHeading id="participles.cg.other-uses">Other uses</SectionHeading>
    <CatGroup>
            <Cat id="participles.cat.attendant-circumstance"name="Attendant Circumstance" eg="“Go and make disciples”" ex={[{ g: "πορευθέντες μαθητεύσατε πάντα τὰ ἔθνη", e: "go and make disciples of all nations", r: "Matt 28:19" }, { g: "ἐγερθεὶς παράλαβε τὸ παιδίον", e: "rise and take the child", r: "Matt 2:13" }]} how={<T id="participles.cat.attendant-circumstance.h">Aorist participle, aorist main verb, participle first, and both carrying the narrative forward. Translate it as a finite verb joined with “and”.</T>}><T id="participles.cat.attendant-circumstance.d">translate as a finite verb + “and”; pigg-backs on the main verb</T></Cat>
            <Cat id="participles.cat.periphrastic"name="Periphrastic" ex={[{ g: "ἦν διδάσκων αὐτοὺς ὡς ἐξουσίαν ἔχων", e: "he was teaching them as one having authority", r: "Mark 1:22" }, { g: "ἦν ὁ λαὸς προσδοκῶν τὸν Ζαχαρίαν", e: "the people were waiting for Zechariah", r: "Luke 1:21" }]} how={<T id="participles.cat.periphrastic.h">A form of <G>εἰμί</G> together with a participle making one verbal idea. The participle is anarthrous and follows the verb.</T>}><T id="participles.cat.periphrastic.d">a participle + a form of <G>εἰμί</G> making one verbal idea</T></Cat>
