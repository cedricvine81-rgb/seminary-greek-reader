...
export const NOUNS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
            ...
            <Cat id="nouns.cat.partitive"name="Partitive" eg="“half of my possessions”" ex={[{ g: "τὰ ἡμίσειά μου τῶν ὑπαρχόντων", e: "half of my possessions", r: "Luke 19:8" }, { g: "τινὲς τῶν γραμματέων", e: "some of the scribes", r: "Matt 9:3" }]}><T id="nouns.cat.partitive.d">the whole of which the head noun is a part</T></Cat>
