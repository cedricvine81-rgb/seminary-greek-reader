...
export const CONJ_ADV_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      ...
      <Cat id="conj-adv.cat.gar" name="γάρ" eg="“for God so loved”" ex={[{ g: "οὕτως γὰρ ἠγάπησεν ὁ Θεὸς τὸν κόσμον", e: "for God so loved the world", r: "John 3:16" }]} how={<T id="conj-adv.cat.gar.h">It never begins its clause, so start looking at the second word. Read “the reason is” in front of the clause to test it: <G>γάρ</G> supports what came before rather than adding something new.</T>}><T id="conj-adv.cat.gar.d">gives the grounds for what was just said — explanation, not a new assertion. Postpositive, so it is never the first word</T></Cat>
      <Cat id="conj-adv.cat.oun" name="οὖν" eg="“therefore what God joined”" ex={[{ g: "ὃ οὖν ὁ Θεὸς συνέζευξεν ἄνθρωπος μὴ χωριζέτω", e: "what therefore God has joined, let no one separate", r: "Matt 19:6" }]} how={<T id="conj-adv.cat.oun.h">Ask whether the clause follows from the one before. If it does, “therefore”; if it merely comes next — and in John it usually does — it is narrative transition, and “so” or nothing is closer.</T>}><T id="conj-adv.cat.oun.d">draws an inference from what precedes — “therefore, so then.” In John it is often merely narrative transition, so weigh the author</T></Cat>
      <Cat id="conj-adv.cat.alla" name="ἀλλά" eg="“not… but”" ex={[{ g: "οὐκ ἦλθον καταλῦσαι ἀλλὰ πληρῶσαι", e: "I did not come to abolish but to fulfil", r: "Matt 5:17" }]} how={<T id="conj-adv.cat.alla.h">Something is being denied and replaced, very often with <G>οὐ… ἀλλά</G> straddling the two halves. Where nothing is cancelled, <G>δέ</G> was the word.</T>}><T id="conj-adv.cat.alla.d">strong adversative — it cancels or replaces, where <G>δέ</G> merely moves on</T></Cat>
    </CatGroup>
