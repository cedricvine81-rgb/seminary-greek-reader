...
export const MI_VERBS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      ...
      <Cat id="mi-verbs.cat.kappa-aorist" name="A κ where others take σ" eg="ἔδωκα, ἔθηκα" ex={[{ g: "τὴν ψυχήν μου τίθημι ὑπὲρ τῶν προβάτων", e: "I lay down my life for the sheep", r: "John 10:15" }]} how={<T id="mi-verbs.cat.kappa-aorist.h">The reduplication has gone and a <G>κ</G> stands where a <G>σ</G> would be. Augment and endings are otherwise the familiar first-aorist ones.</T>}><T id="mi-verbs.cat.kappa-aorist.d">the aorist drops the iota reduplication and takes <G>-κα</G> instead of <G>-σα</G>. Same augment, same endings, different marker</T></Cat>
      <Cat id="mi-verbs.cat.compounds" name="Most of the frequency is in compounds" eg="παραδίδωμι, ἀφίημι, ἀνίστημι" ex={[{ g: "ἀφίενταί σου αἱ ἁμαρτίαι", e: "your sins are forgiven", r: "Mark 2:5" }]} how={<T id="mi-verbs.cat.compounds.h">Strip the preposition before you parse or look anything up. <G>παραδίδωμι</G> is <G>δίδωμι</G> wearing a prefix, and the whole paradigm follows from that.</T>}><T id="mi-verbs.cat.compounds.d">preposition + <G>-μι</G> verb carries much of the class’s New Testament weight, and several of the compounds are theological heavyweights in their own right</T></Cat>
    </CatGroup>
