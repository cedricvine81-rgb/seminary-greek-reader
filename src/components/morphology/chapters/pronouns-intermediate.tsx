...
export const PRONOUNS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      <Cat id="pronouns.cat.personal-emphatic" name="Emphatic personal" eg="“I baptise you… he will baptise you”" ex={[{ g: "ἐγὼ μὲν ὑμᾶς βαπτίζω ἐν ὕδατι", e: "I baptise you with water", r: "Matt 3:11" }, { g: "σὺ εἶ ὁ Υἱός μου ὁ ἀγαπητός", e: "you are my beloved Son", r: "Mark 1:11" }]} how={<T id="pronouns.cat.personal-emphatic.h">The pronoun is nominative when the verb ending has already said who. Anything nominative is there for weight — most often contrast.</T>}><T id="pronouns.cat.personal-emphatic.d">the verb ending already gives the subject, so a nominative <G>ἐγώ</G> or <G>σύ</G> is there for weight or contrast</T></Cat>
      <Cat id="pronouns.cat.intensive" name="Intensive" eg="Ἰησοῦς αὐτός “Jesus himself”" ex={[{ g: "αὐτὸς Δαυεὶδ εἶπεν ἐν τῷ πνεύματι τῷ ἁγίῳ", e: "for David himself said in the Holy Spirit", r: "Mark 12:36" }, { g: "Ἰησοῦς αὐτὸς οὐκ ἐβάπτιζεν", e: "Jesus himself was not baptising", r: "John 4:2" }]} how={<T id="pronouns.cat.intensive.h"><G>αὐτός</G> in predicate position — outside the article–noun bracket. Inside it, with the article, the very same word means “the same”.</T>}><T id="pronouns.cat.intensive.d">stands outside the article–noun unit where there is one, and beside an anarthrous name simply next to it — translated “himself, herself, itself”</T></Cat>
      <Cat id="pronouns.cat.identical" name="Identical" eg="τὸ αὐτό “the same thing”" ex={[{ g: "τὸ αὐτὸ φρονεῖτε", e: "be of the same mind", r: "2 Cor 13:11" }, { g: "τὸν αὐτὸν ἀγῶνα ἔχοντες", e: "having the same struggle", r: "Phil 1:30" }]} how={<T id="pronouns.cat.identical.h">Attributive position: the article comes immediately before <G>αὐτός</G>. Position, not form, is what separates this from the intensive.</T>}><T id="pronouns.cat.identical.d">attributive position, with the article — “the same”</T></Cat>
    </CatGroup>
    <SectionHeading id="pronouns.cg.int-reflexive">The reflexive pronouns</SectionHeading>
    <CatGroup>
      <Cat id="pronouns.cat.reflexive" name="Reflexive" eg="ἑαυτόν “himself” as object" ex={[{ g: "σῶσον σεαυτὸν καταβὰς ἀπὸ τοῦ σταυροῦ", e: "save yourself by coming down from the cross", r: "Mark 15:30" }, { g: "ἀγαπήσεις τὸν πλησίον σου ὡς σεαυτόν", e: "you shall love your neighbour as yourself", r: "Matt 22:39" }]} how={<T id="pronouns.cat.reflexive.h">Never nominative — if it were the subject it would not need to be reflexive. The action comes back on the subject of its own clause.</T>}><T id="pronouns.cat.reflexive.d">the action returns to its own subject; the form only ever appears in the oblique cases, because a reflexive can never be the subject</T></Cat>
      <Cat id="pronouns.cat.reciprocal" name="Reciprocal" eg="ἀλλήλους “one another”" ex={[{ g: "ἀγαπᾶτε ἀλλήλους καθὼς ἠγάπησα ὑμᾶς", e: "love one another as I have loved you", r: "John 13:34" }, { g: "ἀλλήλων τὰ βάρη βαστάζετε", e: "bear one another’s burdens", r: "Gal 6:2" }]} how={<T id="pronouns.cat.reciprocal.h">Plural, and the members act on each other rather than each on himself. <G>ἀλλήλων</G> is the word for it, though <G>ἑαυτούς</G> can shade into this sense.</T>}><T id="pronouns.cat.reciprocal.d">plural only, and always mutual — “one another,” not “themselves”</T></Cat>
    </CatGroup>
    <SectionHeading id="pronouns.cg.int-asking">Asking and leaving open</SectionHeading>
    <CatGroup>
      <Cat id="pronouns.cat.interrogative" name="Interrogative" eg="τίνα ζητεῖς; “whom do you seek?”" ex={[{ g: "τίνα ζητεῖς", e: "whom do you seek?", r: "John 20:15" }, { g: "τί με λέγεις ἀγαθόν", e: "why do you call me good?", r: "Mark 10:18" }]} how={<T id="pronouns.cat.interrogative.h"><G>τίς</G> keeps an acute accent that never becomes a grave. If it is accented, it is asking.</T>}><T id="pronouns.cat.interrogative.d">accented <G>τίς</G>, and it always keeps its accent — “who? what? why?”</T></Cat>
      <Cat id="pronouns.cat.indefinite" name="Indefinite" eg="ἄνθρωπός τις “a certain man”" ex={[{ g: "ἄνθρωπός τις εἶχεν δύο υἱούς", e: "a certain man had two sons", r: "Luke 15:11" }, { g: "ἐάν τις ἀγαπᾷ τὸν κόσμον", e: "if anyone loves the world", r: "1 John 2:15" }]} how={<T id="pronouns.cat.indefinite.h"><G>τις</G> with no accent of its own, leaning back on the word before it. Unaccented means indefinite — the accent is the whole difference.</T>}><T id="pronouns.cat.indefinite.d">enclitic <G>τις</G>, leaning on the word before it — “someone, a certain, any”</T></Cat>
    </CatGroup>
    ...
    <SectionHeading id="pronouns.h.going-deeper-small">Further study: small words, large claims</SectionHeading>
