...
export const PRINCIPAL_PARTS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      <Cat id="principal-parts.cat.present-system" name="1. Present" eg="λύω → ἔλυον" ex={[{ g: "ὁ πιστεύων εἰς τὸν Υἱὸν ἔχει ζωὴν αἰώνιον", e: "the one who believes in the Son has eternal life", r: "John 3:36" }]} how={<T id="principal-parts.cat.present-system.h">No tense marker, and no augment outside the imperfect. Any contraction, reduplication or added <G>ν</G> belongs to this stem alone, which is why it is so often the odd one out.</T>}><T id="principal-parts.cat.present-system.d">present and imperfect, in every voice — and the present stem is the one that contracts, reduplicates or nasalises, so it is often the odd one out</T></Cat>
      <Cat id="principal-parts.cat.future-system" name="2. Future active/middle" eg="λύσω · μενῶ" ex={[{ g: "αὐτὸς δὲ βαπτίσει ὑμᾶς ἐν πνεύματι ἁγίῳ", e: "he will baptise you with the Holy Spirit", r: "Mark 1:8" }]} how={<T id="principal-parts.cat.future-system.h">A <G>σ</G> before the ending, with no augment. If the stem is liquid there will be no <G>σ</G>, so look for the circumflex instead.</T>}><T id="principal-parts.cat.future-system.d">the future in those two voices only. A liquid verb builds it without σ, which is why it can look like a contract present</T></Cat>
      <Cat id="principal-parts.cat.aorist-system" name="3. Aorist active/middle" eg="ἔλυσα → λύσας, λῦσαι" ex={[{ g: "ἀκούσας δὲ ὁ Ἰησοῦς ἐθαύμασεν", e: "when Jesus heard this he marvelled", r: "Matt 8:10" }]} how={<T id="principal-parts.cat.aorist-system.h"><G>σα</G> with an augment gives the indicative; the same stem without the augment gives the participle, infinitive, subjunctive and imperative.</T>}><T id="principal-parts.cat.aorist-system.d">the aorist in those voices, plus its participle, infinitive, subjunctive and imperative — the augment only in the indicative</T></Cat>
      <Cat id="principal-parts.cat.perfect-active" name="4. Perfect active" eg="λέλυκα · γέγραπται" ex={[{ g: "γέγραπται γὰρ ἐν βίβλῳ ψαλμῶν", e: "for it is written in the book of Psalms", r: "Acts 1:20" }]} how={<T id="principal-parts.cat.perfect-active.h">Reduplication at the front and <G>κα</G> in the ending. The reduplication is the mark to look for — no other system carries it in the active.</T>}><T id="principal-parts.cat.perfect-active.d">perfect and pluperfect active, marked by reduplication. The perfect is a state, not a past — which is why this system is worth its own place</T></Cat>
      <Cat id="principal-parts.cat.perfect-middle" name="5. Perfect middle/passive" eg="λέλυμαι" ex={[{ g: "τετέλεσται καὶ κλίνας τὴν κεφαλὴν παρέδωκεν τὸ πνεῦμα", e: "it is finished; and bowing his head he gave up his spirit", r: "John 19:30" }]} how={<T id="principal-parts.cat.perfect-middle.h">Reduplication again, but the endings sit straight on the stem with no connecting vowel — which is why the consonant at the join so often changes.</T>}><T id="principal-parts.cat.perfect-middle.d">the same tenses in the other voices, and the endings attach straight to the stem with no connecting vowel — which is where the consonant changes happen</T></Cat>
      <Cat id="principal-parts.cat.aorist-passive" name="6. Aorist passive" eg="ἐλύθην · ἐγράφη" ex={[{ g: "καὶ ὁ Λόγος σὰρξ ἐγένετο", e: "and the Word became flesh", r: "John 1:14" }]} how={<T id="principal-parts.cat.aorist-passive.h">A <G>θη</G>, or a bare <G>η</G> in the second aorist passive. It is the least predictable of the six, so look it up rather than deriving it.</T>}><T id="principal-parts.cat.aorist-passive.d">aorist and future passive, with the <G>θη</G> marker. A verb can be perfectly regular in five systems and irregular here</T></Cat>
    </CatGroup>
