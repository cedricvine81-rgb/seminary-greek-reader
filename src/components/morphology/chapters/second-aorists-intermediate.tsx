...
export const SECOND_AORISTS_INTERMEDIATE_CONTENT = (
  <>
    ...
    <CatGroup>
      ...
      <Cat id="2nd-aorists.cat.stem-elsewhere" name="The stem outside the indicative" eg="ἔλαβον → λαβών, λαβεῖν" ex={[{ g: "λαβὼν ἄρτον εὐχαριστήσας ἔκλασεν", e: "having taken bread and given thanks, he broke it", r: "Luke 22:19" }]} how={<T id="2nd-aorists.cat.stem-elsewhere.h">Recognise the aorist stem, then check for an augment. Augment means indicative; no augment means participle, infinitive, subjunctive or imperative.</T>}><T id="2nd-aorists.cat.stem-elsewhere.d">the aorist stem powers the aorist participle, infinitive, subjunctive and imperative too — but without the augment, which belongs to the indicative alone</T></Cat>
      <Cat id="2nd-aorists.cat.imperfect-clash" name="Telling it from the imperfect" eg="ἔβαλλον / ἔβαλον" ex={[{ g: "ἐλθοῦσα μία χήρα πτωχὴ ἔβαλεν λεπτὰ δύο", e: "a poor widow came and put in two small coins", r: "Mark 12:42" }]} how={<T id="2nd-aorists.cat.imperfect-clash.h">The endings will not help — compare the stems. A doubled consonant, or the letters the present adds, means imperfect; the bare stem means aorist.</T>}><T id="2nd-aorists.cat.imperfect-clash.d">the endings are the imperfect’s, so only the stem separates them. <G>ἔβαλλον</G> is imperfect, <G>ἔβαλον</G> aorist — one letter, two aspects</T></Cat>
    </CatGroup>
