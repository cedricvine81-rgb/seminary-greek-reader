...
export const HB_SUFFIXES = (
  <>
    ...
    <InfoBox id="suffixes.b1" title="In plain English">
    ...
    <SectionHeading id="suffixes.h1" n={1}>On a singular noun</SectionHeading>
    <MorphTable id="suffixes.t1"
      ...
      highlightCols={[]}
      rows={[
        ['1cs', 'סוּסִ|י', 'my horse'],
        ['2ms', 'סוּסְ|ךָ', 'your horse'],
        ['2fs', 'סוּסֵ|ךְ', 'your horse'],
        ['3ms', 'סוּס|וֹ', 'his horse'],
        ['3fs', 'סוּסָ|הּ', 'her horse  (note the mappiq)'],
        ['1cp', 'סוּסֵ|נוּ', 'our horse'],
        ['2mp', 'סוּסְ|כֶם', 'your horse'],
        ['2fp', 'סוּסְ|כֶן', 'your horse'],
        ['3mp', 'סוּסָ|ם', 'their horse'],
        ['3fp', 'סוּסָ|ן', 'their horse'],
      ]}
    />

    <SectionHeading id="suffixes.h2" n={2}>On a plural noun</SectionHeading>
    <P id="suffixes.p2">
    ...
    <MorphTable id="suffixes.t2"
      title="סוּסִים “horses” + suffixes"
      headers={['', 'Form', 'Meaning']}
      hCols={[1]}
      tCols={[2]}
      rows={[
        ['1cs', 'סוּסַ|י', 'my horses'],
        ['2ms', 'סוּסֶי|ךָ', 'your horses'],
        ['2fs', 'סוּסַיִ|ךְ', 'your horses'],
        ['3ms', 'סוּסָ|יו', 'his horses  (pronounce -av)'],
        ['3fs', 'סוּסֶי|הָ', 'her horses'],
        ['1cp', 'סוּסֵי|נוּ', 'our horses'],
        ['2mp', 'סוּסֵי|כֶם', 'your horses'],
        ['2fp', 'סוּסֵי|כֶן', 'your horses'],
        ['3mp', 'סוּסֵי|הֶם', 'their horses'],
        ['3fp', 'סוּסֵי|הֶן', 'their horses'],
      ]}
      note="Feminine plurals in ־וֹת take these same “plural-style” suffixes on top of the ות: תּוֹרוֹתָיו “his laws”."
    />

    <SectionHeading id="suffixes.h3" n={3}>On prepositions</SectionHeading>
    <MorphTable id="suffixes.t3"
      title="Prepositions + suffixes"
      headers={['', 'לְ “to”', 'בְּ “in”', 'עִם “with”', 'מִן “from”', 'עַל “on”  (plural-style)']}
      hCols={[1, 2, 3, 4, 5]}
      rows={[
        ['1cs', 'לִי', 'בִּי', 'עִמִּ|י', 'מִמֶּנִּ|י', 'עָלַ|י'],
        ['2ms', 'לְךָ', 'בְּךָ', 'עִמְּ|ךָ', 'מִמְּ|ךָ', 'עָלֶי|ךָ'],
        ['2fs', 'לָךְ', 'בָּךְ', 'עִמָּ|ךְ', 'מִמֵּ|ךְ', 'עָלַיִ|ךְ'],
        ['3ms', 'לוֹ', 'בּוֹ', 'עִמּ|וֹ', 'מִמֶּ|נּוּ', 'עָלָ|יו'],
        ['3fs', 'לָהּ', 'בָּהּ', 'עִמָּ|הּ', 'מִמֶּנָּ|ה', 'עָלֶי|הָ'],
        ['1cp', 'לָנ|וּ', 'בָּנ|וּ', 'עִמָּ|נוּ', 'מִמֶּ|נּוּ', 'עָלֵי|נוּ'],
        ['2mp', 'לָכֶ|ם', 'בָּכֶ|ם', 'עִמָּ|כֶם', 'מִכֶּ|ם', 'עֲלֵי|כֶם'],
        ['3mp', 'לָהֶ|ם', 'בָּהֶ|ם', 'עִמָּ|הֶם', 'מֵהֶ|ם', 'עֲלֵי|הֶם'],
      ]}
      note="אֶל “to” declines like עַל: אֵלַי, אֵלֶיךָ, אֵלָיו… Note מִמֶּנּוּ is BOTH “from him” and “from us” — context decides."
    />

    <SectionHeading id="suffixes.h4" n={4}>On the object marker</SectionHeading>
    <MorphTable id="suffixes.t4"
    ...
    <SectionHeading id="suffixes.h5" n={5}>On verbs</SectionHeading>
    <P id="suffixes.p3">
    ...
    <InfoBox id="suffixes.b2" title="Watch for">
