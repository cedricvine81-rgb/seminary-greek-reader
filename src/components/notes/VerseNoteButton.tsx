    ...
    <span ref={wrapRef} className="relative inline-block align-middle" onMouseEnter={onEnter} onMouseLeave={onLeave}>
      ...
      {noted && showPreview && !open && (
        <div
          ...
          role="tooltip"
        >
          <div className="w-72 max-w-[80vw] rounded-lg border border-gray-200 bg-popover p-2.5 shadow-lg">
      ...
      {open && mounted && createPortal(
        <div
          ref={panelRef}
          className="fixed z-[60] w-[min(92vw,560px)] max-h-[85vh] flex flex-col rounded-xl bg-popover shadow-2xl border border-gray-200 overflow-hidden"
