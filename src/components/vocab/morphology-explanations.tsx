  ...
  imperatives: {
    ...
    intermediate: (
      <Note>
        ...
        <Hook><T id="imperatives.exp.hook.prohibitions-split-aspect">Prohibitions split across two moods, because Greek barely uses a 2nd-person aorist imperative with <G>μή</G>: the aorist <em>subjunctive</em> fills the gap. The old rule — present = “stop”, aorist = “don’t start” — is a first approximation, not a law; the chapter shows Matthew using both of the same command six verses apart.</T></Hook>
