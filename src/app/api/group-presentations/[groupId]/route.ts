...
import { saveMyContribution, attestMyContribution, submitGroupPresentation } from '@/lib/group-presentations'
...
export async function POST(req: NextRequest, { params }: { params: { groupId: string } }) {
  try {
    ...
    const expected = ['Presentation not found', 'Not a member of this group', 'Not enrolled', 'Already submitted', 'Add your AI/sources statement before signing', 'The deadline has passed. Ask your instructor to approve a late submission.']
