    ...
    <main>
      ...
      <section className="py-16 px-6 bg-parchment-50">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <div className="bg-surface rounded-2xl shadow-sm border border-parchment-200 p-8">
          ...
          <Link href="/" className="inline-block btn-primary px-6 py-2.5 text-sm">
      ...
      <section className="py-16 px-6 bg-brand-800 text-white">
        <div className="max-w-xl mx-auto text-center space-y-4">
          ...
          <div className="flex gap-3 justify-center">
            <Link href="/auth/sign-up?role=STUDENT" className="btn bg-surface text-brand-800 hover:bg-brand-50 px-6 py-2.5 font-semibold text-sm">
              Sign up as Student
            </Link>
