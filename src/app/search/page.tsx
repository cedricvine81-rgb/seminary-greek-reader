...
export default function SearchPage({ searchParams }: { searchParams: { q?: string; in?: string } }) {
  return (
    <div className="py-2 pb-16">
      <SearchPageView initialQuery={searchParams?.q} initialScope={searchParams?.in} />
    </div>
  )
}
